...
- 💻 **Cursando Especialização em Inteligência Artificial e Tecnologias Educacionais** | PUC-MINAS
- 💼 **Bolsista FAPESP (TT)** | FEA-USP  
  *Atuação no projeto "Avaliação e síntese do impacto da pesquisa em Administração na sociedade".*
- 🔬 **Mestre em Administração** | PPGA-USCS  
...
#### 👥 Grupos de Pesquisa
*   🧬 **Integrante do Grupo de Pesquisa:** *Análise de Redes Sociais: relação com as áreas de biotecnologia, nanotecnologias e tecnologias habilitadoras da indústria 4.0, sustentabilidade, inovação, capacidades absortivas e cocriação de valor.*
